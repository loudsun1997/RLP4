def add_arguments(parser):
    ...
    parser.add_argument('--dqn_type', type=str, default='dqn', choices=['double dqn', 'dueling dqn', 'dqn', 'double dueling dqn', 'split dqn', 'ddqn noisy', 'split dqn noisy'], help='choose dqn model')
